...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <title>Enrol Add Subject</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="Enrol-Add-Subject.css" media="screen">
    ...
    <meta property="og:title" content="Enrol Add Subject">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class=" u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-clearfix u-header u-section-row-container" id="sec-b654" style="background-image: none"><div class="u-section-rows">
    ...
    <section class="u-clearfix u-section-1" id="sec-5329">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-1">Add Subject</h1>
        <div class="u-form u-form-1">
        <form action="Enrolment.php" method="get" name="form" class="u-form-spacing-10" style="padding: 10px;">
          <!-- <form action="https://forms.nicepagesrv.com/Form/Process" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="email" name="form" style="padding: 10px;"> -->
            <div class="u-form-group u-form-select u-form-group-1">
              ...
              <div class="u-form-select-wrapper">
                <select id="select-f3ed" name="subject_id" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            ...
            <div class="u-align-left u-form-group u-form-submit">
              <a href="Enrolment.php" class="u-btn u-btn-submit u-button-style">OK</a>
