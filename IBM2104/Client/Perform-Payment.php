...
<link rel="stylesheet" href="Perform-Payment.css" media="screen">
    ...
    <meta property="og:title" content="Perform Payment">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class=" u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-clearfix u-header u-section-row-container" id="sec-b654" style="background-image: none"><div class="u-section-rows">
    ...
    <section class="u-clearfix u-section-1" id="sec-ac93">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-1">Perform Payment</h1>
        <div class="u-form u-form-1">
          <form action="https://forms.nicepagesrv.com/Form/Process" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="email" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-name">
              <label for="name-90b5" class="u-label">Card Number</label>
              <input type="text" placeholder="Enter your Card Number" id="name-90b5" name="name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <div class="u-form-group u-form-group-2">
              <label for="text-9afa" class="u-label">Amount</label>
              <input type="text" placeholder="Enter Amount" id="text-9afa" name="text" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            </div>
            <div class="u-form-group u-form-group-2">
              <label for="file-0001" class="u-label">Receipt</label>
              <input type="file" id="file-0001" name="receipt" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            </div>
            <div class="u-align-left u-form-group u-form-submit">
              <a href="Home.php" class="u-btn u-btn-submit u-button-style">Submit</a>
