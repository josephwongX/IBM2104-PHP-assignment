...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <title>AD Add Subject</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="AD-Add-Subject.css" media="screen">
    ...
    <meta property="og:title" content="AD Add Subject">
        ...
        <!--<form action="Add-Drop.php" method="get" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" name="form" style="padding: 10px;">-->
            <div class="u-form-group u-form-select u-form-group-1">
              ...
              <div class="u-form-select-wrapper">
                <select id="select-f3ed" name="subject_id" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
            ...
            <div class="u-form-group u-form-select u-form-group-2">
              ...
              <div class="u-form-select-wrapper">
                <select id="select-ff32" name="section" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
            ...
            <input type="hidden" name="ad_action" value="ADD">
