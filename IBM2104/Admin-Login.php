<?php 
 	...
 	if (isset($_POST['login'])) {
 		...
 		$cmd = " select * from admin where employee_id = '$username' AND password = '$password' limit 1";
            ...
            <div class="u-form u-login-control u-form-1">
              <form method="post" class="u-clearfix u-form-custom-backend u-form-spacing-35 u-form-vertical u-inner-form" source="custom" name="form-2" style="padding: 10px;" redirect="true">
                ...
                <div class="u-align-center u-form-group u-form-submit">
                  <a class="u-btn u-btn-round u-btn-submit u-button-style u-radius-17 u-btn-1">Login for Admin<br>
                  </a>
                  <input type="submit" value="submit" name="login" class="u-form-control-hidden">
                </div>
