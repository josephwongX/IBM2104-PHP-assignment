...
<link rel="stylesheet" href="Student-Login.css" media="screen">
  ...
  <body data-home-page="Student-Login.php" data-home-page-title="Student Login" class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-header" id="sec-b654"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-align-center u-container-style u-group u-radius-50 u-shape-round u-white u-group-1">
          <div class="u-container-layout u-container-layout-1">
            ...
            <div class="u-form u-login-control u-form-1">
              <form action="" method="post" class="u-clearfix u-form-custom-backend u-form-spacing-35 u-form-vertical u-inner-form" source="custom" name="form-2" style="padding: 10px;" redirect="true">
                ...
                <div class="u-align-center u-form-group u-form-submit">
                  <a class="u-btn u-btn-round u-btn-submit u-button-style u-radius-17 u-btn-1">Login for Students</a>
                  <input type="submit" name="login" value="login" class="u-form-control-hidden">
                </div>
                <input type="hidden" value="" name="recaptchaResponse">
              </form>
            </div>
            <a href="" class="u-border-1 u-border-active-palette-2-base u-border-hover-palette-2-base u-border-no-left u-border-no-right u-border-no-top u-btn u-button-style u-login-control u-login-forgot-password u-none u-text-palette-2-base u-btn-2">Forgot password?</a>
          </div>
        </div>
      </div>
    </section>
