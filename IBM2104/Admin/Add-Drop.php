...
<link rel="stylesheet" href="Add-Drop.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class=" u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-clearfix u-header u-section-row-container" id="sec-b654" style="background-image: none"><div class="u-section-rows">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-9dc9">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-1">Add / Drop</h1>
          ...
          <table class="u-table-entity u-table-entity-1">
            ...
            <thead class="u-black u-table-header u-table-header-1">
              <tr style="height: 21px;">
                ...
                <th class="u-border-1 u-border-black u-table-cell">Student Action</th>
                ...
                <th class="u-border-1 u-border-black u-table-cell">Status Action</th>
              </tr>
            </thead>
            <tbody class="u-table-body">
            <?php 			        
              $sql1 = "select * from add_drop";
              $res1 = mysqli_query($con , $sql1);
              
              
              while($data1 = mysqli_fetch_assoc($res1)){
                echo '<tr style="height: 54px;">
                <td class="u-border-1 u-border-grey-30 u-table-cell">'.$data1["student_id"].'</td>
                ...
                <td class="u-border-1 u-border-grey-30 u-table-cell">';
                  if ($data1['Status'] == 'Pending') {
                    echo '<a class="u-border-none u-btn u-button-style u-hover-palette-1-dark-1 u-palette-4-base u-btn-5" href="Update_AD.php?update=approve&ad_no='.$data1['ad_no'].'&enroll_no='.$data1['enroll_no'].'">APPROVE</a> 
                    <a class="u-border-none u-btn u-button-style u-hover-palette-1-dark-1 u-palette-2-base u-btn-6" href="Update_AD.php?update=reject&ad_no='.$data1['ad_no'].'&enroll_no='.$data1['enroll_no'].'">REJECT</a>';
